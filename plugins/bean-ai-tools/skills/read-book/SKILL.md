---
name: read-book
description: "Reading coach: guides users through books systematically with knowledge compilation, mastery testing, spaced repetition, and knowledge querying. Use when user says 'read this book with me', 'book study', 'start studying X', 'reading plan', 'ingest this chapter', 'review what I read', 'quiz me on the book', 'what did the book say about X', or invokes /read-book. Supports sub-commands: ingest, query, review, compare, status. Triggers: book, study, read, chapter, ingest, review, quiz, reading plan, book notes."
---
...
```
/read-book <book-name>                    # Start a new book or resume progress
/read-book <book-name> --chapter 3        # Jump to chapter 3
/read-book ingest                         # Compile current chapter to wiki
/read-book query <keyword>               # Query the knowledge base
/read-book review                         # Spaced repetition review
/read-book compare <book-A> <book-B>     # Cross-book comparison
/read-book questions                      # View open questions
/read-book status                         # View all reading progress
```
...
When user returns to `/read-book <book-name>`:
...
Every `/read-book <book-name>` session:
